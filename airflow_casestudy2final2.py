...
CLUSTER_NAME = "testing-cluster" # Name for your Dataproc cluster
...
PYSPARK_URI = f"gs://casestudy2testing/pyspark_casestudy2.py"
# The "*.parquet" is crucial here, as Spark writes multiple part files.
PARQUET_OUTPUT_URI = f"gs://casestudy2testing/processed/*.parquet"
...
# --- DAG Definition ---
with DAG(
    "casestudy2", # Unique DAG ID (changed to avoid conflicts with previous broken versions)
